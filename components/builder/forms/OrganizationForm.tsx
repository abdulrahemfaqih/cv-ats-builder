...
import { OrganizationEntry } from "@/types/cv";
...
function SortableOrgItem({
  ...
  const handleFieldChange = (field: keyof OrganizationEntry, val: unknown) => {
    updateEntry(sectionId, entry.id, { [field]: val } as Partial<OrganizationEntry>);
  };
